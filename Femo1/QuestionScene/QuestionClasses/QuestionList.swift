...
class QuestionList {
    ...
    init() {
        ...
        list.append(Question(questionText: "What is DRY short for?", choiceA: "Don't Repeat Yourself", choiceB: "Do Repeat Yourself", choiceC: "Do Really Yell", choiceD: "Don't React Yodelling", answer: 1))
        ...
        list.append(Question(questionText: "In the command line, what does 'cat' do?", choiceA: "List directories", choiceB: "Make a new directory", choiceC: "Move up one directory", choiceD: "List the contents of a file", answer: 4))
        ...
        list.append(Question(questionText: "Which one of these languages was originally called Oak?", choiceA: "PHP", choiceB: "Java", choiceC: "C++", choiceD: "Coffeescript", answer: 2))
        ...
        list.append(Question(questionText: "What symbol in Javascript seperates statements?", choiceA: ":", choiceB: "<>", choiceC: ";", choiceD: "{}", answer: 3))
